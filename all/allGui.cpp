...
namespace Examples {
	...
	public:
		Frame() : wxFrame(nullptr, wxID_ANY, "All Gui") {
			SetToolBar(toolBar);
			...
			toolBar->AddTool(wxID_CUT, "&Cut", wxArtProvider::GetBitmap(wxART_CUT));
			...
			toolBar->AddSeparator();
			toolBar->AddTool(wxID_PRINT, "&Print...",  wxArtProvider::GetBitmap(wxART_HELP));
			toolBar->AddSeparator();
			...
			menuOptions->AppendSeparator();
			menuOptions->Append(ID_OPTIONG, "Option G\tAlt+6", "", wxITEM_RADIO);
			menuOptions->Append(ID_OPTIONH, "Option H\tAlt+7", "", wxITEM_RADIO);
			...
			toolBar->Realize();
			toolBar->Bind(wxEVT_MENU, [&](wxCommandEvent& event) { static std::map<int, std::string> names = {{wxID_NEW, "New"}, {wxID_OPEN, "Open..."}, {wxID_SAVE, "Save"}, {wxID_EXIT, "Quit"}, {wxID_CUT, "Cut"}, {wxID_COPY, "Copy"}, {wxID_PASTE, "Paste"}, {wxID_PRINT, "Print..."}, {wxID_ABOUT, "About..."}, {wxID_ANY, "Any"}};
			listBox2->Append(names.find(event.GetId()) != names.end() ? names[event.GetId()] : "Unknown");
			if (event.GetId() == wxID_EXIT) Close();
			});
			
			mainMenu->Bind(wxEVT_MENU, [&](wxCommandEvent& event) {
			 static std::map<int, std::string> names = {{wxID_NEW, "File/New"}, {wxID_OPEN, "File/Open..."}, {ID_OPENRECENTFILE1,  "File/Open recent/File 1"}, {ID_OPENRECENTFILE2, "File/Open recent/File 2"}, {ID_OPENRECENTFILE3, "File/Open reccent/File 3"}, {ID_OPENRECENTFILE4, "File/Open recent/File 4"},  {ID_OPENRECENTFILE5, "File/Open recent/File 5"}, {wxID_CLOSE, "File/Close"}, {wxID_SAVE, "File/Save"}, {wxID_SAVEAS, "File/Save as..."}, {wxID_PAGE_SETUP, "File/Page setup..."}, {wxID_PRINT, "File/Print..."}, {wxID_EXIT, "File/Quit"}, {wxID_UNDO, "Edit/Undo"}, {wxID_REDO, "Edit/Redo"}, {wxID_CUT, "Edit/Cut"}, {wxID_COPY, "Edit/Copy"}, {wxID_PASTE, "Edit/Paste"}, {wxID_SELECTALL, "Edit/Select All"}, {wxID_PREFERENCES, "Edit/Preferences"}, {wxID_BACKWARD, "View/Back"}, {wxID_FORWARD, "View/Forward"}, {ID_SHOW, "View/Show"}, {ID_HIDE, "View/Hide"}, {ID_OPTIONA, "Options/Option A"}, {ID_OPTIONB, "Options/Option B"}, {ID_OPTIONC, "Options/Option C"}, {ID_OPTIOND, "Options/Option D"}, {ID_OPTIONE, "Options/Option E"}, {ID_OPTIONF, "Options/Option F"}, {ID_OPTIONG, "Options/Option G"}, {ID_OPTIONH, "Options/Option"}, {ID_OPTIONI, "Options/Option I"}, {wxID_HELP_CONTEXT, "Help/Context"}, {wxID_HELP_INDEX, "Help/Index"}, {wxID_HELP_SEARCH, "Help/Search"}, {wxID_ABOUT, "Help/About"}, {wxID_ANY, "Any"}};
	...
	private:
		...
		wxListBox* listBox2 = new wxListBox(this, wxID_ANY, {10, 20});
